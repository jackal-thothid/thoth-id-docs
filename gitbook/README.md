...
thoth.id is a decentralized naming service on the Hathor Network. It maps human-readable names such as `username.htr` to wallet addresses, so you can send funds and use dApps without long, complex addresses.

* **A digital identity:** register a name that represents you on the Hathor Network.
* **Simpler transactions:** send and receive funds with your name instead of a wallet address.
* **A portable reputation:** use the same name across every dApp that supports thoth.id.
