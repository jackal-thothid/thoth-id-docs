...
![The thoth.id landing page](assets/web-app/landing-hero.jpg)
...
That's it. There is no thoth.id account, no password, and no sign-up. Your wallet *is* your identity.
...
![The waitlist dialog](assets/web-app/waitlist-dialog.jpg)
