---
description: The public page of a name and the tabs you use to manage it.
icon: globe
---
...
![The domain page, Profile tab](../.gitbook/assets/domain-profile.jpg)
...
Edit controls simply don't appear for visitors. The exact rules for changing roles — including why the NFT sometimes has to be _deposited_ first — are on the [Ownership](ownership.md) page.
