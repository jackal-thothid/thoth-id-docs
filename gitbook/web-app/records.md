...
![The Records tab, seen by the name's manager](../assets/web-app/domain-records.jpg)
...
A name with no records reads *No custom records found for this domain.*
...
* **✏️ Edit** — turns the value into an input; **Save** submits the change.
* **🗑️ Delete** — removes the record.
